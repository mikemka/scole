...
// минус один месяц содержится в том же или предыдущем учебном периоде,
// что и редактируемая дата). Если редактирование не разрешено и не определена
// переменная pincode[дата-класс], показываем модальное окно запроса пин-кода.
...
const td2inp = (id, grOld) => {
   ...
   let mesyac    = Number(dtCur[1]), // уменьшаем текущую дату на 1 месяц
